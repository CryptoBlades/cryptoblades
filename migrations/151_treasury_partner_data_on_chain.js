...
module.exports = async function (deployer, network) {
  ...
  if (network === 'bscmainnet' || network === 'bscmainnet-fork') {
    await treasury.setProjectLogo(0, 'https://ipfs.io/ipfs/QmfFrzugbKQorVcHEN9uxT6cb7puXEb4JaC9gLmb7cnoUG?filename=oasis.png');
    ...
    await treasury.setProjectLogo(1, 'https://ipfs.io/ipfs/QmfFrzugbKQorVcHEN9uxT6cb7puXEb4JaC9gLmb7cnoUG?filename=oasis.png');
    ...
    await treasury.setProjectLogo(2, 'https://ipfs.io/ipfs/QmPzUdgiNAsrxMG8VRhF6cYiV7QDTidBFZWAwq7wNRLZuc?filename=seedify.png');
    ...
    await treasury.setProjectLogo(3, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(4, 'https://ipfs.io/ipfs/QmbY1XB3E7f8aL4SXpwhSUTPqeZqae1Rbju86G1jLPb3FF?filename=KING.png');
    ...
    await treasury.setProjectLogo(5, 'https://ipfs.io/ipfs/QmYn5WydPnmYezWoYM4Wrx21fsWfQid1tHNSidVoZKNydL?filename=bithotel.png');
    ...
    await treasury.setProjectLogo(6, 'https://ipfs.io/ipfs/QmTALP9xWB3ProsG17CES9KAf19JCirJ1mn6Cg7g4sYr3J?filename=altura.png');
    ...
    await treasury.setProjectLogo(7, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(8, 'https://ipfs.io/ipfs/QmZjAng3sKmzWFwNvh8kNWf42TbwiNvQfakup5cnLqWiGT?filename=ageoftanks.png');
    ...
    await treasury.setProjectLogo(9, 'https://ipfs.io/ipfs/QmZjAng3sKmzWFwNvh8kNWf42TbwiNvQfakup5cnLqWiGT?filename=ageoftanks.png');
    ...
    await treasury.setProjectLogo(10, 'https://ipfs.io/ipfs/QmagaMYNd6z18CWyq4FGPpos7JmuZ4z9pzJjhmtfk6P37p?filename=cakemonster.png');
    ...
    await treasury.setProjectLogo(11, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(12, 'https://ipfs.io/ipfs/QmUWexgvqWV5bBHumALDAPqcQqb2v3HdPL7UWKHQF6Ay1Q?filename=spintop.png');
    ...
    await treasury.setProjectLogo(13, 'https://ipfs.io/ipfs/QmT7iyL7n9uKNixekNN5pJKkQdWzCnPAxk593YcRiE4AAm?filename=hololoot.png');
    ...
    await treasury.setProjectLogo(0, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(1, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(2, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(0, 'https://ipfs.io/ipfs/QmQCkVftyGVYrfo5wZeEHiTh8yCe4CJsTuAzQy85HNrUD6?filename=cryptomeda.png');
    ...
    await treasury.setProjectLogo(2, 'https://ipfs.io/ipfs/QmRMiiWKmYe4k4uQuAXnjZqsW1GUYzPjAZDWQnChgkVkNi?filename=tryhards.png');
    ...
    await treasury.setProjectLogo(4, 'https://ipfs.io/ipfs/QmV88cTGPMPDAw3wnEaLXPHw7cBtZSSNkqGmmAemxmKKDz?filename=SKILL.png');
    ...
    await treasury.setProjectLogo(5, 'https://ipfs.io/ipfs/QmRz7gaLnrWC96nxpeoeJLZ8ABzJWWY33f4L8srKHLC2Zv?filename=novacreed.png');
