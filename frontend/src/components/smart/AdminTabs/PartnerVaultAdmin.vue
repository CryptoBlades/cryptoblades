<template>
  <div class="p-1">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <b-button @click="storeNfts()" :disabled="storeNftsButtonDisabled" variant="info" class="text-nowrap">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <b-button @click="storeCurrency()" :disabled="storeCurrencyButtonDisabled" variant="info"
                class="text-nowrap">
        {{ $t('admin.partnerVault.storeInPartnerVault') }}
      </b-button>
    </div>
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <b-button @click="checkNftsBalance()" :disabled="checkNftsBalanceButtonDisabled" variant="info"
                class="text-nowrap">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <b-button @click="checkCurrencyBalance()" :disabled="checkCurrencyBalanceButtonDisabled" variant="info"
                class="text-nowrap">
