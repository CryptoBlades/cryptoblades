  ...
  <div class="partner-div m-4">
    <div class="d-flex relative">
      ...
      <div class="d-flex flex-column justify-content-center ml-2">
        ...
        <span v-if="!isGold" class="multiplier-text">{{ skillToPartnerRatio }} SKILL/{{ partnerProject.tokenSymbol }}</span>
        <span v-else class="multiplier-text">1.0000 GOLD/GOLD</span>
        ...
        <span v-if="!isGold" :class="+multiplier < 0.5 ? 'very-low-multiplier' : (+multiplier < 0.75 ? 'low-multiplier' : '')"
...
export default Vue.extend({
  ...
  computed: {
    ...
    isGold(): boolean {
      return this.partnerProject.isGold;
    }
  },
