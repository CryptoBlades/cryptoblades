...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      const blade = this.weapon.blade % bladeCount;
      const crossGuard = this.weapon.crossguard % crossGuardCount;
      const grip = this.weapon.grip % gripCount;
      const pommel = this.weapon.pommel % pommelCount;
