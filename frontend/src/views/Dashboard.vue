...
.overlay-bg {
  position: absolute;
  background: linear-gradient(rgba(24, 24, 24, 0), rgba(34, 33, 33, 0)), url("../assets/second-anniversary/dashboard-bg.gif");
...
.raid-container {
  display: flex;
  flex-direction: row;
  background-image: url("../assets/second-anniversary/raid-bg.gif");
  background-repeat: no-repeat;
  background-size: 110%;
  width: 65%;
  height: 100%;
...
.pvp-container {
  ...
  flex-direction: column;
  align-items: left;
  background-image: url("../assets/second-anniversary/arena-bg.gif");
  background-repeat: no-repeat;
  background-size: 110%;
  width: 100%;
  height: 100%;
...
.pve-container {
  ...
  flex-direction: column;
  align-items: left;
  background-image: url("../assets/second-anniversary/adventure-bg.gif");
  background-repeat: no-repeat;
  background-size: 110%;
  width: 100%;
  height: 100%;
