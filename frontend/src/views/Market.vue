          ...
          <div class="col">
            ...
            <div class="row button-row">
              <div class="col">
                <b-button
                  variant="primary"
                  @click="searchAllListingsByType('character')"  id="gtag-link-others" tagname="browse_characters">Browse Characters</b-button>
              </div>

              <div class="col">
                <b-button
                  variant="primary"
                  @click="searchAllListingsByType('weapon')"  id="gtag-link-others" tagname="browse_weapons">Browse Weapons</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  ...
                  @click="purchaseNft()"  id="gtag-link-others" tagname="confirm_purchase">Purchase</b-button>
              </div>
            ...
            <div class="row buttons-row mt-3">
              <div class="col">
                <b-button
                  variant="primary"
                  :disabled="!search"
                  @click="searchListingsByNftId('character')"  id="gtag-link-others" tagname="search_character_id">Search Character ID</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  variant="primary"
                  :disabled="!search"
                  @click="searchListingsByNftId('weapon')"  id="gtag-link-others" tagname="search_weapon_id">Search Weapon ID</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  variant="primary"
                  :disabled="!search"
                  @click="searchListingsBySeller('weapon')"  id="gtag-link-others" tagname="weapons_seller">Weapons by Seller</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  variant="primary"
                  :disabled="!search"
                  @click="searchListingsBySeller('character')"  id="gtag-link-others" tagname="characters_seller">Characters by Seller</b-button>
              </div>

              <div class="col">
                <b-button
                  variant="primary"
                  @click="searchOwnListings('weapon')"  id="gtag-link-others" tagname="search_own_weapons">Search My Weapons</b-button>
              </div>

              <div class="col">
                <b-button
                  variant="primary"
                  @click="searchOwnListings('character')"  id="gtag-link-others" tagname="search_own_characters">Search My Characters</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  ...
                  @click="updateNftListingPrice()"  id="gtag-link-others" tagname="change_price">Change Price</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  ...
                  @click="cancelNftListing()"  id="gtag-link-others" tagname="cancel_listing">Cancel Listing</b-button>
              </div>
            </div>
          ...
          <div class="col">
            <div class="row button-row">
              <div class="col">
                <b-button
                  variant="primary"
                  @click="activeType = 'weapon'"  id="gtag-link-others" tagname="show_weapons_market">Show Weapons</b-button>
              </div>

              <div class="col">
                <b-button
                  variant="primary"
                  @click="activeType = 'character'"  id="gtag-link-others" tagname="show_characters_market">Show Characters</b-button>
              </div>
              ...
              <div class="col">
                <b-button
                  variant="primary"
                  v-if="activeType === 'weapon'"
                   id="gtag-link-others" tagname="add_listing_weapon"
                ...
                <b-button
                  ...
                  v-if="activeType === 'character'"
                  :disabled="selectedNftId === null || selectedNftOnCooldown"
                   id="gtag-link-others" tagname="add_listing_character"
