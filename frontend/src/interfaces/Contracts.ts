...
import type {
  ...
  WeaponCosmetics, CharacterCosmetics, NFTStorage, ERC20Bridge, CBKLandSale, CBKLand, Treasury, Promos, BurningManager, SimpleQuests,
...
export interface Contracts {
  ...
  ERC20Bridge?: Contract<ERC20Bridge>;
