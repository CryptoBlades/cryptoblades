...
contract TokensManager is Initializable, AccessControlUpgradeable {
    ...
    function fight(uint256 char, uint8 enemyIndex, uint8 fightMultiplier) external payable {
        (uint256 tokens, uint256 expectedTokens) = game.fight(msg.sender, char, enemyIndex, fightMultiplier);
