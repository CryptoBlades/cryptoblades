...
contract Characters is Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function customMint(address minter, uint16 xp, uint8 level, uint8 trait, uint256 seed, uint256 tokenID, uint24 burnPoints) minterOnly public returns (uint256) {
        ...
        nftVars[tokenID][NFTVAR_BONUS_POWER] = burnPoints;
