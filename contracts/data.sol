...
contract Data is Util {
    ...
    uint256 public mintCharacterFee = 5 ether;
    uint256 public rerollTraitFee = 5 ether;
    uint256 public rerollCosmeticsFee = 5 ether;
    uint256 public refillStaminaFee = 10 ether;
