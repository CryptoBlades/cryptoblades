...
contract Weapons is Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function mint(address minter, uint256 seed, uint256 chosenElement) public restricted returns(uint256) {
        uint256 stars;
    ...
    function mintWeaponWithStars(address minter, uint256 stars, uint256 seed, uint256 chosenElement) public restricted returns(uint256) {
    ...
    function getRandomProperties(uint256 stars, uint256 seed, uint256 chosenElement) public pure returns (uint16) {
        uint256 trait;
